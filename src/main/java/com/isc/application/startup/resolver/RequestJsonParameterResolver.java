package com.isc.application.startup.resolver;


import com.isc.application.startup.resolver.requestJsonParemeterResolverImpl.parameter.IArgumentResolver;
 ...
 * @create: 18/12/2017
 **/
public class RequestJsonParameterResolver implements HandlerMethodArgumentResolver {

    protected static final Logger LOGGER = LoggerFactory.getLogger(RequestJsonParameterResolver.class);
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        return methodParameter.hasParameterAnnotation(RequestJsonParamResolver.class);
    }
